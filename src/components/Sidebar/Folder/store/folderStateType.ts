...
type localActionFolder = {
  ...
  setDataUpdate: (data: Partial<folderTypes>) => void;
};

export type folderState = localStateFolder & localActionFolder;
export type NameType = Pick<folderState, 'name' | 'setName'>;
export type createFolderType = Pick<
  folderState,
  'toggleCreate' | 'setToggleCreate'
>;
export type editFolderType = Pick<
  folderState,
  'toggleEditFolder' | 'setToggleEditFolder'
>;
export type updateFolderType = Pick<
  folderState,
